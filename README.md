...
---
### ⭐ Featured Project
- **Task Management API** — ASP.NET Core Web API + EF Core + SQL Server | RESTful CRUD Operations  
  → [View repo](https://github.com/simona312/TaskAPI)

### 🎓 Training
- .NET Developer Program — Code Academy (2020–2021)
